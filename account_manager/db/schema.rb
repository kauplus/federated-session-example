...
ActiveRecord::Schema.define(:version => 20120821145239) do
  ...
  add_index "oauth2_access_tokens", ["account_sid", "user_id"], :name => "index_oauth2_access_tokens_on_account_sid_and_user_id"
  ...
  create_table "oauth2_clients", :force => true do |t|
    ...
    t.datetime "created_at",                                          :null => false
    t.datetime "updated_at",                                          :null => false
    t.boolean  "uses_account_sid",                 :default => false
    t.string   "session_expired_notification_uri"
  end
